...
num_of_duplicate=10
# divide number of rows by number of duplicates
num_rows=`expr $num_rows / $num_of_duplicate` 
echo "number of distinctive rows: $num_rows"
...
do
	...
	do 
        ...
        command="$NUMA ../../lib/main ${subroutine} real.d mkl single ${OMP_NUM_THREADS} $line_id"
