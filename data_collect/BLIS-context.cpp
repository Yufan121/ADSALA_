...
//gemm
void BLIS_context::dgemm(int m, int k, int n, double alpha, double *A, double *B, double beta, double *C) {
  cblas_dgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m, n, k, alpha, A, k, B, n, beta, C, n);
}
void BLIS_context::sgemm(int m, int k, int n, float alpha, float *A, float *B, float beta, float *C) {
    cblas_sgemm(CblasRowMajor, CblasNoTrans, CblasNoTrans, m, n, k, alpha, A, k, B, n, beta, C, n);
}

// symm
void BLIS_context::dsymm(int m, int n, double alpha, double *A, double *B, double beta, double *C) {
  cblas_dsymm(CblasRowMajor, CblasLeft, CblasUpper, m, n, alpha, A, m, B, n, beta, C, n);
}
void BLIS_context::ssymm(int m, int n, float alpha, float *A, float *B, float beta, float *C) {
  cblas_ssymm(CblasRowMajor, CblasLeft, CblasUpper, m, n, alpha, A, m, B, n, beta, C, n);
}

// syrk
void BLIS_context::dsyrk(int n, int k, double alpha, double *A, double beta, double *C) {
  cblas_dsyrk(CblasRowMajor, CblasUpper, CblasNoTrans, n, k, alpha, A, k, beta, C, n);
}
void BLIS_context::ssyrk(int n, int k, float alpha, float *A, float beta, float *C) {
  cblas_ssyrk(CblasRowMajor, CblasUpper, CblasNoTrans, n, k, alpha, A, k, beta, C, n);
}

//syr2k
void BLIS_context::dsyr2k(int n, int k, double alpha, double *A, double *B, double beta, double *C) {
  cblas_dsyr2k(CblasRowMajor, CblasUpper, CblasNoTrans, n, k, alpha, A, k, B, k, beta, C, n);
}
void BLIS_context::ssyr2k(int n, int k, float alpha, float *A, float *B, float beta, float *C) {
  cblas_ssyr2k(CblasRowMajor, CblasUpper, CblasNoTrans, n, k, alpha, A, k, B, k, beta, C, n);
}

// trmm
void BLIS_context::dtrmm(int m, int n, double alpha, double *A, double *B) {
  cblas_dtrmm(CblasRowMajor, CblasLeft, CblasUpper, CblasNoTrans, CblasNonUnit, m, n, alpha, A, m, B, n);
}
void BLIS_context::strmm(int m, int n, float alpha, float *A, float *B) {
  cblas_strmm(CblasRowMajor, CblasLeft, CblasUpper, CblasNoTrans, CblasNonUnit, m, n, alpha, A, m, B, n);
}

// trsm
void BLIS_context::dtrsm(int m, int n, double alpha, double *A, double *B) {
  cblas_dtrsm(CblasRowMajor, CblasLeft, CblasUpper, CblasNoTrans, CblasNonUnit, m, n, alpha, A, m, B, n);
}
void BLIS_context::strsm(int m, int n, float alpha, float *A, float *B) {
...
void BLIS_context::sgemv(int m, int n, float alpha, float *A, float *x, float beta, float *y) {
...
// }
// syr
void BLIS_context::dsyr(int n, double alpha, double *x, double *A) {
  cblas_dsyr(CblasRowMajor, CblasUpper, n, alpha, x, 1, A, n);
}
void BLIS_context::ssyr(int n, float alpha, float *x, float *A) {
  cblas_ssyr(CblasRowMajor, CblasUpper, n, alpha, x, 1, A, n);
}

// trsv
void BLIS_context::dtrsv(int n, double *A, double *x) {
  cblas_dtrsv(CblasRowMajor, CblasUpper, CblasNoTrans, CblasNonUnit, n, A, n, x, 1);
}
void BLIS_context::strsv(int n, float *A, float *x) {
...
// dot product
void BLIS_context::ddot(int n, double *x, double *y) {
  cblas_ddot(n, x, 1, y, 1);
}
void BLIS_context::sdot(int n, float *x, float *y) {
  cblas_sdot(n, x, 1, y, 1);
}

// axpy
void BLIS_context::daxpy(int n, double alpha, double *x, double *y) {
  cblas_daxpy(n, alpha, x, 1, y, 1);
}
void BLIS_context::saxpy(int n, float alpha, float *x, float *y) {
