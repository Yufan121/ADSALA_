...
#OMP_NUM_THREADS=128 GOMP_CPU_AFFINITY="$((th1+0))-$((th1+63)),$((th1+128))-$((th1+OMP_NUM_THREADS+64-1))" numactl -i all /home/mdelapierre/hpc-dummies/misc/xthi_aocc >0.affinity.test.out
