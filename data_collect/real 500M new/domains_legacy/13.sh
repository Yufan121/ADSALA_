...
do
	...
	do 
		...
		export GOMP_CPU_AFFINITY="0-$cpu_m1"
        	...
        	echo $line_id
		${NUMA} ../../lib/main 13.d blis single ${OMP_NUM_THREADS} $line_id # remember to change this, since a template
	done
